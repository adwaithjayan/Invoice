          ...
          <div className='min-h-screen w-full flex justify-center items-center'>
                ...
                <Card className='w-[380px] px-5'>
                      <CardHeader className='text-center'>
                            <div
                                className='mb-4 flex mx-auto size-20 items-center justify-center rounded-full bg-blue-100'>
                      ...
                      <CardContent>
                            <div className='mt-4 rounded-md bg-yellow-50 border border-yellow-300 p-4'>
                                  <div className='flex items-center'>
                                        ...
                                        <p className='text-sm font-medium text-yellow-700 ml-3'>Be sure to check your
                                              span folder</p>
                                  </div>
                            </div>
                      </CardContent>
